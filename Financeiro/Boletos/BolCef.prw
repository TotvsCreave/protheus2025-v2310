...
Static Function Monta_Tela()
	...
	oDlgBol:cCaption := "Impressão de Boletos CEF (104)"
	oDlgBol:nLeft := 0
	oDlgBol:nTop := 0
	oDlgBol:nWidth := 970
	oDlgBol:nHeight := 499
...
Static Function Carrega_Titulos()
	...
	If MV_PAR07 = 1
		cQuery += " AND SA1.A1_XBCOBOL = '" + MV_PAR01 + "' "
	Endif
...
Static Function Impress(oPrint,aBitmap,aDadosEmp,aDadosTit,aDadosBanco,aDatSacado,aBolText,CB_RN_NN)
	...
	oPrint:Say  (0950,400 ,"EM TODA A REDE BANCÁRIA E SEUS CORRESPONDENTES ATÉ O VALOR LIMITE.",oFont8 )
	...
	oPrint:Say  (2165,400 ,"EM TODA A REDE BANCÁRIA E SEUS CORRESPONDENTES ATÉ O VALOR LIMITE.",oFont8 )
