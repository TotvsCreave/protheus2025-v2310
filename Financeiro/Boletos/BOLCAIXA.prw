...
Static Function Monta_Tela()
	...
	oDlgBol:cCaption := "Impressão de Boletos CAIXA (104)"
	oDlgBol:nLeft := 0
	oDlgBol:nTop := 0
	oDlgBol:nWidth := 970
	oDlgBol:nHeight := 499
...
Static Function Carrega_Titulos()
	...
	cQuery += "A1_XIMPBOL = '2' and "
	cQuery += "SubStr(SA1.A1_XBCOBOL,1,3) = '104' "
...
Static Function Confirma()
	...
	If !_cBanco $ "104"
		Aviso( "Atenção", "Banco Inválido!" + chr(10) + chr(10) +;
			"Esta rotina está configurada apenas para o banco CEF(104).", { "Ok" }, 2 )
		Return
	Endif
