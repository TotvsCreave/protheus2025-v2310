...
/*/
|=======================================================================|
| PROGRAMA: RELBAIXAS | ANALISTA: Fabiano Cintra   |  DATA: 16/02/2016  |
|-----------------------------------------------------------------------|
| DESCRIÇÃO: Relatório de Baixas por Vendedor.							|
|-----------------------------------------------------------------------|
| Uso: P11 - Faturamento - AVECRE   					                |
|=======================================================================|
/*/

User Function RelBaixas()
...
cabec1 := "Vendedor                 Dt.Baixa       Vencimento                     Vl.Título     Vl.Recebido        Título    Cliente "
cabec2 := ""                                                                                               
...
/*											
			cQuery := ""                      
			cQuery += "SELECT SE1.E1_FILIAL, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA, SE1.E1_NOMCLI, SE1.E1_VENCREA, SE1.E1_BAIXA, SE1.E1_XDOCAVE, "
			...
			cQuery += "		 SE5.E5_CONTA = '" + cConta + "' "
			If !Empty(cVend)
				cQuery += "		 AND SE1.E1_VEND1 = '" + cVend + "' "
			Endif
			cQuery += "ORDER BY SE1.E1_VEND1, SE1.E1_BAIXA, SE1.E1_PREFIXO, SE1.E1_NUM, SE1.E1_PARCELA"
*/

			cQuery := ""                      
			cQuery += "SELECT SE5.E5_DATA, SE5.E5_PREFIXO, SE5.E5_NUMERO, SE5.E5_PARCELA, SE5.E5_BENEF, SE5.E5_VALOR, "
			cQuery += "       SE1.E1_VENCREA, SE1.E1_VALOR, SE1.E1_XDOCAVE, SE1.E1_VEND1 "
