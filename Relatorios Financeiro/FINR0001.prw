...
User Function FINR0001()
	...
	If pergunte("RELCOBR")
		...
		if lOK
			...
			cArquivo := "FINR0001_"+MV_PAR03+"_"+MV_PAR04
			...
			Else
				oPrn:=  FWMSPrinter():New("FINR0001_"+MV_PAR03+"_"+MV_PAR04, , lAdjustToLegacy,cLocal, lDisableSetup, , , , , , .T., )
			Endif
...
Static Function fSendCobr(_cPara, _cAssunto, _cTexto, _cAnexo)
