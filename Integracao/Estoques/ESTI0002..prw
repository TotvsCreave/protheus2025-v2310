...
/*
|=============================================================================|
| PROGRAMA..: ESTI0002 |   ANALISTA: Sidnei Lempk   |      DATA: 08/03/2021   |
|=============================================================================|
| DESCRICAO.: Rotina para lançamento de devoluções ao estoque.                |
|=============================================================================|
| PARÂMETROS:                                                                 |
|                                                                             |
|                                                                             |
...
|=============================================================================|
*/
user function ESTI0002()

	Local _aCab1    := {}
	Local _aItem    := {}
	Local _atotitem := {}
	Local cCodigoTM := "460" //Devolucao de vendas
	Local cCodProd  := ''
	Local cLocal    := ''
	Local cUnid     := ''
    Local cCustos   := '002001011'   //Estoques
...
/*
ID_DEVOLUCAO	NUMBER
DATA_DEV	VARCHAR2(14 BYTE)
CLIENTE_DEV	VARCHAR2(6 BYTE)
LOJA_CLIENTE_DEV	VARCHAR2(2 BYTE)
VENDEDOR_DEV	VARCHAR2(6 BYTE)
NF_ORIGEM_DEV	VARCHAR2(9 BYTE)
SERIE_NF_ORIGEM_DEV	VARCHAR2(3 BYTE)
ITEM_DEV	VARCHAR2(3 BYTE)
QTD_DEV	FLOAT
PESO_DEV	FLOAT
MOTIVO_DEV	VARCHAR2(6 BYTE)
ALMOX_DESTINO_DEV	VARCHAR2(2 BYTE)
USERCREATED_DEV	VARCHAR2(8 BYTE)
DATACREATED_DEV	VARCHAR2(14 BYTE)
USERUPDATE_DEV	VARCHAR2(8 BYTE)
DATAUPDATE_DEV	VARCHAR2(14 BYTE)
OBSERVACAO_DEV	VARCHAR2(256 BYTE)
STATUS_DEV	VARCHAR2(1 BYTE)
*/
